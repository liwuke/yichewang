...
class IpDownloadMiddleware :
    ip_list = ['https://114.217.243.25:8118',
...
class YichewangSpiderMiddleware :
...
class YichewangDownloaderMiddleware :
    # Not all methods need to be defined. If a method is not defined,
